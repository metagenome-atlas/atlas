...
m_config_file = "/home/whit040/Programs/Das_Pipeline/Projects/das_test/das_config.txt"
m_param_file = "/home/whit040/Programs/Das_Pipeline/Projects/das_test/das_param.txt"
...
def search_for_contaminants(read_pair_id, db_name):
...
def decon(read_pair_id):
    ...
    for db_name in contaminant_dbs:
        ...
        search_for_contaminants(read_pair_id, db_name)
...
def trim_reads(read_pair_id):
   ...
   #-------------------------------------------------------------------------------------------------------------------
    ...
    for db_name in contaminant_dbs:
        picard_fastq_file_name = read_pair_id + "_Unaligned_Extended_Frags_Concat.fastq"
        picard_fastq_file_path = os.path.join(decon_dir, picard_fastq_file_name)
