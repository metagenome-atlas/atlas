...
for variable in df.columns[:2]:
    ...
    div[variable]= plotly_embed_div(offline.plot(data.iplot(asFigure=True,kind='bar',
                                           xTitle='Samples',
                                           yTitle=variable.replace('_',' '),layout=layout_x_45), **plotly_params))
...
Footer=\
    """
    This report need an internet connection to vizualize the interactive figures.
    """
...
report(Combined_report,
       report_out, stylesheet= stylesheet ,**report_params)
