...
# @
@click.option("--majority_threshold", type=float, default=0.51, show_default=True, help="constitutes a majority fraction at tree node for 'lca-majority' ORF aggregation method")
...
@click.option("--sample", multiple=True, help="sample definitions, FASTA file path, and optionally, FASTQ file path(s)")
...
# @click.option("--diamond-block-size", type=int, default=2, show_default=True, help="sequence block size in billions of letters")
